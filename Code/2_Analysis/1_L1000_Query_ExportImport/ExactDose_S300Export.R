# L1000-Query Bulk Export Script (Exact Dose Comparison; Upper Bound - S300)
...
inDir = 'Data/Subset/'
queryDir = 'L1000_S300/Query/'
workDir = 'L1000_S300/WorkList/'
logDir = 'L1000_S300/WorkList/LOGS/'
...
for (currentBatch in 1:finalBatch) {
	...
	for (currentIndex in startIndex:endIndex) {
		...
		currentName = cmapMini[currentIndex, sprintf('S300.%s_%s_%s', cell_id, trt_iname, case_ID)]
